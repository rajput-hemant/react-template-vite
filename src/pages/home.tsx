    ...
    <main>
      <header className="container">
        ...
        <p className="mt-5 text-xl">
          ...
          <Span>TailwindCSS</Span>, <Span>React Router</Span> and pre-configured
      ...
      <section className="container mt-10 flex flex-col items-center gap-4 lg:flex-row">
        ...
        >
          ...
          <span>degit rajput-hemant/react-template-vite my-react-app</span>
      ...
      <section className="container mt-10 grid grid-cols-2 gap-5 lg:grid-cols-3">
        {features.map((feature) => (
          <div className="group rounded-xl border border-zinc-600 bg-zinc-800/75 p-6 transition-colors duration-300 hover:border-green-500 hover:shadow-lg hover:shadow-green-600">
